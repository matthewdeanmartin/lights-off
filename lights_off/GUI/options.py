...
class general(wx.Panel, wx.Dialog):
	def __init__(self, parent):
		...
		self.demojify_tweet=wx.CheckBox(self, -1, "Remove emojis and other unicode characters from post text")
...
class templates(wx.Panel, wx.Dialog):
	def __init__(self, parent):
		...
		self.main_box = wx.BoxSizer(wx.VERTICAL)
		self.tweetTemplate_label = wx.StaticText(self, -1, "Post template")
		self.main_box.Add(self.tweetTemplate_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.tweetTemplate = wx.TextCtrl(self, -1, "", size=(500,-1))
		self.main_box.Add(self.tweetTemplate, 0, wx.ALL|wx.EXPAND, 10)
		self.tweetTemplate.AppendText(globals.prefs.tweetTemplate)
		self.quoteTemplate_label = wx.StaticText(self, -1, "Quote template")
		self.main_box.Add(self.quoteTemplate_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.quoteTemplate = wx.TextCtrl(self, -1, "", size=(500,-1))
		self.main_box.Add(self.quoteTemplate, 0, wx.ALL|wx.EXPAND, 10)
		self.quoteTemplate.AppendText(globals.prefs.quoteTemplate)
		self.retweetTemplate_label = wx.StaticText(self, -1, "Boost template")
		self.main_box.Add(self.retweetTemplate_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.retweetTemplate = wx.TextCtrl(self, -1, "", size=(500,-1))
		self.main_box.Add(self.retweetTemplate, 0, wx.ALL|wx.EXPAND, 10)
		self.retweetTemplate.AppendText(globals.prefs.retweetTemplate)
		self.copyTemplate_label = wx.StaticText(self, -1, "Copy template")
		self.main_box.Add(self.copyTemplate_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.copyTemplate = wx.TextCtrl(self, -1, "", size=(500,-1))
		self.main_box.Add(self.copyTemplate, 0, wx.ALL|wx.EXPAND, 10)
		...
		self.main_box.Add(self.messageTemplate_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.messageTemplate = wx.TextCtrl(self, -1, "", size=(500,-1))
		self.main_box.Add(self.messageTemplate, 0, wx.ALL|wx.EXPAND, 10)
		self.messageTemplate.AppendText(globals.prefs.messageTemplate)
		self.userTemplate_label = wx.StaticText(self, -1, "User template")
		self.main_box.Add(self.userTemplate_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.userTemplate = wx.TextCtrl(self, -1, "", size=(500,-1))
		self.main_box.Add(self.userTemplate, 0, wx.ALL|wx.EXPAND, 10)
...
class advanced(wx.Panel, wx.Dialog):
	def __init__(self, parent):
		...
		self.main_box.Add(self.update_time_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.update_time = wx.TextCtrl(self, -1, "", size=(120,-1))
		...
		self.main_box.Add(self.user_limit_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.user_limit = wx.TextCtrl(self, -1, "", size=(120,-1))
		self.main_box.Add(self.user_limit, 0, wx.ALL, 10)
		self.user_limit.AppendText(str(globals.prefs.user_limit))
		self.count_label = wx.StaticText(self, -1, "Number of posts to fetch per call (Maximum is 200)")
		self.main_box.Add(self.count_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.count = wx.TextCtrl(self, -1, "", size=(120,-1))
		self.main_box.Add(self.count, 0, wx.ALL, 10)
		self.count.AppendText(str(globals.prefs.count))
		self.streaming=wx.CheckBox(self, -1, "Enable streaming for home, notifications, and list timelines (Requires restart to disable)")
		self.main_box.Add(self.streaming, 0, wx.ALL, 10)
		self.streaming.SetValue(globals.prefs.streaming)
		self.media_player_label=wx.StaticText(self, -1,"Media Player path")
		self.main_box.Add(self.media_player_label, 0, wx.LEFT|wx.RIGHT|wx.TOP, 10)
		self.media_player=wx.FilePickerCtrl(self, -1, "", "Path to external Media Player")
		self.main_box.Add(self.media_player, 0, wx.ALL|wx.EXPAND, 10)
		self.media_player.SetPath(globals.prefs.media_player)
		self.SetSizer(self.main_box)

class OptionsGui(wx.Dialog):
	def __init__(self):
		wx.Dialog.__init__(self, None, title="Options", style=wx.DEFAULT_DIALOG_STYLE|wx.RESIZE_BORDER)
